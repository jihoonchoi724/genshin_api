...
class CharacterBasicSerializer(serializers.ModelSerializer):
  class Meta:
    model = Character
    fields = ["character_id", "name", "vision", "weapon", "nation", "rarity", "birthday", "release_version", "title", "affiliation", "constellation_name"]
...
class CharacterSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = Character
    fields = ["character_id", "name", "vision", "weapon", "nation", "rarity", "birthday", "release_version", "title", "affiliation", "constellation_name", "talents", "constellations"]
