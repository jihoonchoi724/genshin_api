...
class Character(models.Model):
  ...
  class Meta:
    ordering = ["name"],
    constraints = [
      models.UniqueConstraint(fields=["character_id", "name"], name="unique_character")
    ]
  

class Talent(models.Model):
  character = models.ForeignKey(Character, related_name="talents", on_delete=models.CASCADE)
  ...
  class Meta:
    constraints = [
      models.UniqueConstraint(fields=["order","talent_type", "talent_name", "talent_desc"], name="unique_talent")
    ]

class Constellation(models.Model):
  character = models.ForeignKey(Character, related_name="constellations", on_delete=models.CASCADE)
  ...
  class Meta:
    constraints = [
      models.UniqueConstraint(fields=["con_number", "con_name", "con_desc"], name="unique_constellation")
    ]
